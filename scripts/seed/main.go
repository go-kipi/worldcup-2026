...
func main() {
	...
	slots := []models.KnockoutSlot{
		...
		// =========================================
		{
			...
			Kickoff:   parseDate("2026-06-28 16:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-02",
			...
			Kickoff:   parseDate("2026-06-28 20:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-03",
			...
			Kickoff:   parseDate("2026-06-29 16:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-04",
			...
			Kickoff:   parseDate("2026-06-29 20:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-05",
			...
			HomeLabel: ptr("1E"),
			AwayLabel: ptr("2F"),
			Kickoff:   parseDate("2026-06-30 16:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-06",
			...
			HomeLabel: ptr("1F"),
			AwayLabel: ptr("2E"),
			Kickoff:   parseDate("2026-06-30 20:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-07",
			...
			HomeLabel: ptr("1G"),
			AwayLabel: ptr("2H"),
			Kickoff:   parseDate("2026-07-01 16:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-08",
			...
			HomeLabel: ptr("1H"),
			AwayLabel: ptr("2G"),
			Kickoff:   parseDate("2026-07-01 20:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-09",
			...
			HomeLabel: ptr("1I"),
			AwayLabel: ptr("2J"),
			Kickoff:   parseDate("2026-07-02 16:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-10",
			...
			HomeLabel: ptr("1J"),
			AwayLabel: ptr("2I"),
			Kickoff:   parseDate("2026-07-02 20:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-11",
			...
			HomeLabel: ptr("1K"),
			AwayLabel: ptr("2L"),
			Kickoff:   parseDate("2026-07-03 16:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-12",
			...
			HomeLabel: ptr("1L"),
			AwayLabel: ptr("2K"),
			Kickoff:   parseDate("2026-07-03 20:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-13",
			...
			HomeLabel: ptr("2A"),
			AwayLabel: ptr("2B"),
			Kickoff:   parseDate("2026-07-04 16:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-14",
			...
			HomeLabel: ptr("2C"),
			AwayLabel: ptr("2D"),
			Kickoff:   parseDate("2026-07-04 20:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-15",
			...
			Kickoff:   parseDate("2026-07-05 16:00:00"),
		},
		{
			Round:     "R32",
			SlotCode:  "R32-16",
			...
			AwayLabel: ptr("3C/D/E"),
			Kickoff:   parseDate("2026-07-05 20:00:00"),
		},
		...
		// =========================================
		{
			...
			Kickoff:   parseDate("2026-07-07 16:00:00"),
		},
		{
			Round:     "R16",
			SlotCode:  "R16-02",
			...
			Kickoff:   parseDate("2026-07-07 20:00:00"),
		},
		{
			Round:     "R16",
			SlotCode:  "R16-03",
			...
			Kickoff:   parseDate("2026-07-08 16:00:00"),
		},
		{
			Round:     "R16",
			SlotCode:  "R16-04",
			...
			Kickoff:   parseDate("2026-07-08 20:00:00"),
		},
		{
			Round:     "R16",
			SlotCode:  "R16-05",
			...
			Kickoff:   parseDate("2026-07-09 16:00:00"),
		},
		{
			Round:     "R16",
			SlotCode:  "R16-06",
			...
			Kickoff:   parseDate("2026-07-09 20:00:00"),
		},
		{
			Round:     "R16",
			SlotCode:  "R16-07",
			...
			Kickoff:   parseDate("2026-07-10 16:00:00"),
		},
		{
			Round:     "R16",
			SlotCode:  "R16-08",
			...
			Kickoff:   parseDate("2026-07-10 20:00:00"),
		},
		...
		// =========================================
		{
			...
			Kickoff:   parseDate("2026-07-11 16:00:00"),
		},
		{
			Round:     "QF",
			SlotCode:  "QF-02",
			...
			Kickoff:   parseDate("2026-07-11 20:00:00"),
		},
		{
			Round:     "QF",
			SlotCode:  "QF-03",
			...
			Kickoff:   parseDate("2026-07-12 16:00:00"),
		},
		{
			Round:     "QF",
			SlotCode:  "QF-04",
			...
			Kickoff:   parseDate("2026-07-12 20:00:00"),
		},
		...
		// =========================================
		{
			...
			Kickoff:   parseDate("2026-07-14 20:00:00"),
		},
		{
			Round:     "SF",
			SlotCode:  "SF-02",
			...
			Kickoff:   parseDate("2026-07-15 20:00:00"),
		},
		...
		// =========================================
		{
			...
			Kickoff:   parseDate("2026-07-18 16:00:00"),
		},
		...
		// =========================================
		{
			...
			Kickoff:   parseDate("2026-07-19 20:00:00"),
		},
	}
	...
	matches := []models.Match{
		...
		// =========================
		{
			...
			HomeTeam:    "MEX",
			AwayTeam:    "RSA",
			Kickoff:     *parseDate("2026-06-11 20:00:00"),
		},
		{
			GroupCode:   "A",
			...
			HomeTeam:    "KOR",
			AwayTeam:    "CZE",
			Kickoff:     *parseDate("2026-06-12 02:00:00"),
		},
		{
			GroupCode:   "A",
			...
			HomeTeam:    "MEX",
			AwayTeam:    "KOR",
			Kickoff:     *parseDate("2026-06-16 20:00:00"),
		},
		{
			GroupCode:   "A",
			...
			HomeTeam:    "RSA",
			AwayTeam:    "CZE",
			Kickoff:     *parseDate("2026-06-17 01:00:00"),
		},
		{
			GroupCode:   "A",
			...
			HomeTeam:    "RSA",
			AwayTeam:    "KOR",
			Kickoff:     *parseDate("2026-06-22 18:00:00"),
		},
		{
			GroupCode:   "A",
		...
		// =========================
		{
			...
			HomeTeam:    "CAN",
			AwayTeam:    "BIH",
			Kickoff:     *parseDate("2026-06-12 19:00:00"),
		},
		{
			GroupCode:   "B",
			...
			HomeTeam:    "QAT",
			AwayTeam:    "SUI",
			Kickoff:     *parseDate("2026-06-14 03:00:00"),
		},
		{
			GroupCode:   "B",
			...
			HomeTeam:    "CAN",
			AwayTeam:    "QAT",
			Kickoff:     *parseDate("2026-06-17 19:00:00"),
		},
		{
			GroupCode:   "B",
			...
			HomeTeam:    "BIH",
			AwayTeam:    "SUI",
			Kickoff:     *parseDate("2026-06-18 01:00:00"),
		},
		{
			GroupCode:   "B",
			...
			HomeTeam:    "BIH",
			AwayTeam:    "QAT",
			Kickoff:     *parseDate("2026-06-23 18:00:00"),
		},
		{
			GroupCode:   "B",
		...
		// =========================
		{
			...
			HomeTeam:    "BRA",
			AwayTeam:    "MAR",
			Kickoff:     *parseDate("2026-06-13 16:00:00"),
		},
		{
			GroupCode:   "C",
			...
			HomeTeam:    "HAI",
			AwayTeam:    "SCO",
			Kickoff:     *parseDate("2026-06-13 19:00:00"),
		},
		{
			GroupCode:   "C",
			...
			HomeTeam:    "BRA",
			AwayTeam:    "HAI",
			Kickoff:     *parseDate("2026-06-18 18:00:00"),
		},
		{
			GroupCode:   "C",
			...
			HomeTeam:    "MAR",
			AwayTeam:    "SCO",
			Kickoff:     *parseDate("2026-06-19 01:00:00"),
		},
		{
			GroupCode:   "C",
			...
			HomeTeam:    "MAR",
			AwayTeam:    "HAI",
			Kickoff:     *parseDate("2026-06-24 18:00:00"),
		},
		{
			GroupCode:   "C",
		...
		// =========================
		{
			...
			HomeTeam:    "USA",
			AwayTeam:    "PAR",
			Kickoff:     *parseDate("2026-06-13 02:00:00"),
		},
		{
			GroupCode:   "D",
			...
			HomeTeam:    "AUS",
			AwayTeam:    "TUR",
			Kickoff:     *parseDate("2026-06-14 02:00:00"),
		},
		{
			GroupCode:   "D",
			...
			HomeTeam:    "USA",
			AwayTeam:    "AUS",
			Kickoff:     *parseDate("2026-06-18 22:00:00"),
		},
		{
			GroupCode:   "D",
			...
			HomeTeam:    "PAR",
			AwayTeam:    "TUR",
			Kickoff:     *parseDate("2026-06-19 03:00:00"),
		},
		{
			GroupCode:   "D",
			...
			HomeTeam:    "PAR",
			AwayTeam:    "AUS",
			Kickoff:     *parseDate("2026-06-25 02:00:00"),
		},
		{
			GroupCode:   "D",
		...
		// =========================
		{
			...
			HomeTeam:    "GER",
			AwayTeam:    "CUW",
			Kickoff:     *parseDate("2026-06-14 16:00:00"),
		},
		{
			GroupCode:   "E",
			...
			HomeTeam:    "CIV",
			AwayTeam:    "ECU",
			Kickoff:     *parseDate("2026-06-14 22:00:00"),
		},
		{
			GroupCode:   "E",
			...
			HomeTeam:    "GER",
			AwayTeam:    "CIV",
			Kickoff:     *parseDate("2026-06-20 19:00:00"),
		},
		{
			GroupCode:   "E",
			...
			HomeTeam:    "ECU",
			AwayTeam:    "CUW",
			Kickoff:     *parseDate("2026-06-20 22:00:00"),
		},
		{
			GroupCode:   "E",
			...
			HomeTeam:    "CUW",
			AwayTeam:    "CIV",
			Kickoff:     *parseDate("2026-06-25 19:00:00"),
		},
		{
			GroupCode:   "E",
		...
		// =========================
		{
			...
			HomeTeam:    "NED",
			AwayTeam:    "JPN",
			Kickoff:     *parseDate("2026-06-15 00:00:00"),
		},
		{
			GroupCode:   "F",
			...
			HomeTeam:    "SWE",
			AwayTeam:    "TUN",
			Kickoff:     *parseDate("2026-06-15 03:00:00"),
		},
		{
			GroupCode:   "F",
			...
			HomeTeam:    "NED",
			AwayTeam:    "SWE",
			Kickoff:     *parseDate("2026-06-20 16:00:00"),
		},
		{
			GroupCode:   "F",
			...
			HomeTeam:    "JPN",
			AwayTeam:    "TUN",
			Kickoff:     *parseDate("2026-06-21 01:00:00"),
		},
		{
			GroupCode:   "F",
			...
			HomeTeam:    "JPN",
			AwayTeam:    "SWE",
			Kickoff:     *parseDate("2026-06-25 22:00:00"),
		},
		{
			GroupCode:   "F",
		...
		// =========================
		{
			...
			HomeTeam:    "BEL",
			AwayTeam:    "EGY",
			Kickoff:     *parseDate("2026-06-16 02:00:00"),
		},
		{
			GroupCode:   "G",
			...
			HomeTeam:    "IRN",
			AwayTeam:    "NZL",
			Kickoff:     *parseDate("2026-06-16 05:00:00"),
		},
		{
			GroupCode:   "G",
			...
			HomeTeam:    "BEL",
			AwayTeam:    "IRN",
			Kickoff:     *parseDate("2026-06-21 02:00:00"),
		},
		{
			GroupCode:   "G",
			...
			HomeTeam:    "NZL",
			AwayTeam:    "EGY",
			Kickoff:     *parseDate("2026-06-21 19:00:00"),
		},
		{
			GroupCode:   "G",
			...
			HomeTeam:    "EGY",
			AwayTeam:    "IRN",
			Kickoff:     *parseDate("2026-06-26 02:00:00"),
		},
		{
			GroupCode:   "G",
		...
		// =========================
		{
			...
			HomeTeam:    "ESP",
			AwayTeam:    "CPV",
			Kickoff:     *parseDate("2026-06-15 19:00:00"),
		},
		{
			GroupCode:   "H",
			...
			HomeTeam:    "KSA",
			AwayTeam:    "URU",
			Kickoff:     *parseDate("2026-06-15 22:00:00"),
		},
		{
			GroupCode:   "H",
			...
			HomeTeam:    "ESP",
			AwayTeam:    "KSA",
			Kickoff:     *parseDate("2026-06-21 16:00:00"),
		},
		{
			GroupCode:   "H",
			...
			HomeTeam:    "URU",
			AwayTeam:    "CPV",
			Kickoff:     *parseDate("2026-06-21 22:00:00"),
		},
		{
			GroupCode:   "H",
			...
			HomeTeam:    "CPV",
			AwayTeam:    "KSA",
			Kickoff:     *parseDate("2026-06-26 19:00:00"),
		},
		{
			GroupCode:   "H",
		...
		// =========================
		{
			...
			HomeTeam:    "FRA",
			AwayTeam:    "SEN",
			Kickoff:     *parseDate("2026-06-16 19:00:00"),
		},
		{
			GroupCode:   "I",
			...
			HomeTeam:    "IRQ",
			AwayTeam:    "NOR",
			Kickoff:     *parseDate("2026-06-16 22:00:00"),
		},
		{
			GroupCode:   "I",
			...
			HomeTeam:    "FRA",
			AwayTeam:    "IRQ",
			Kickoff:     *parseDate("2026-06-22 19:00:00"),
		},
		{
			GroupCode:   "I",
			...
			HomeTeam:    "NOR",
			AwayTeam:    "SEN",
			Kickoff:     *parseDate("2026-06-22 22:00:00"),
		},
		{
			GroupCode:   "I",
			...
			HomeTeam:    "NOR",
			AwayTeam:    "FRA",
			Kickoff:     *parseDate("2026-06-26 16:00:00"),
		},
		{
			GroupCode:   "I",
		...
		// =========================
		{
			...
			HomeTeam:    "ARG",
			AwayTeam:    "ALG",
			Kickoff:     *parseDate("2026-06-17 00:00:00"),
		},
		{
			GroupCode:   "J",
			...
			HomeTeam:    "AUT",
			AwayTeam:    "JOR",
			Kickoff:     *parseDate("2026-06-17 03:00:00"),
		},
		{
			GroupCode:   "J",
			...
			HomeTeam:    "ARG",
			AwayTeam:    "AUT",
			Kickoff:     *parseDate("2026-06-22 02:00:00"),
		},
		{
			GroupCode:   "J",
			...
			HomeTeam:    "JOR",
			AwayTeam:    "ALG",
			Kickoff:     *parseDate("2026-06-22 05:00:00"),
		},
		{
			GroupCode:   "J",
			...
			HomeTeam:    "ALG",
			AwayTeam:    "AUT",
			Kickoff:     *parseDate("2026-06-27 00:00:00"),
		},
		{
			GroupCode:   "J",
		...
		// =========================
		{
			...
			HomeTeam:    "POR",
			AwayTeam:    "COD",
			Kickoff:     *parseDate("2026-06-17 16:00:00"),
		},
		{
			GroupCode:   "K",
		...
		},
		{
			...
			HomeTeam:    "POR",
			AwayTeam:    "UZB",
			Kickoff:     *parseDate("2026-06-23 16:00:00"),
		},
		{
			GroupCode:   "K",
			...
			HomeTeam:    "COL",
			AwayTeam:    "COD",
			Kickoff:     *parseDate("2026-06-23 19:00:00"),
		},
		{
			GroupCode:   "K",
			...
			HomeTeam:    "COL",
			AwayTeam:    "POR",
			Kickoff:     *parseDate("2026-06-27 19:00:00"),
		},
		{
			GroupCode:   "K",
		...
		// =========================
		{
			...
			HomeTeam:    "ENG",
			AwayTeam:    "CRO",
			Kickoff:     *parseDate("2026-06-18 00:00:00"),
		},
		{
			GroupCode:   "L",
			...
			HomeTeam:    "GHA",
			AwayTeam:    "PAN",
			Kickoff:     *parseDate("2026-06-18 03:00:00"),
		},
		{
			GroupCode:   "L",
			...
			HomeTeam:    "ENG",
			AwayTeam:    "GHA",
			Kickoff:     *parseDate("2026-06-23 22:00:00"),
		},
		{
			GroupCode:   "L",
			...
			HomeTeam:    "PAN",
			AwayTeam:    "CRO",
			Kickoff:     *parseDate("2026-06-24 01:00:00"),
		},
		{
			GroupCode:   "L",
			...
			HomeTeam:    "PAN",
			AwayTeam:    "ENG",
			Kickoff:     *parseDate("2026-06-28 00:00:00"),
		},
		{
			GroupCode:   "L",
...
func parseDate(d string) *time.Time {
	t, err := time.Parse(time.DateTime, d)
	if err != nil {
		panic(err)
	}
